        ...
        <div className="outline-div">
          ...
          <div className="time-flex">
            <span className="right">
              ...
              <p>
                The HackyTime tech hackathon 1.0 is formally announced to the
                general public and teams begin to get ready to register
              </p>
              <h3 className="mobile-date">July 18, 2023</h3>
            </span>
            <h3 className="left-date">July 18, 2023</h3>
          </div>
          <div className="time-flex">
            <h3 className="right-date">July 18, 2023</h3>
            <span className="left">
              <h3>Hackathon Announcement</h3>
              <p>
