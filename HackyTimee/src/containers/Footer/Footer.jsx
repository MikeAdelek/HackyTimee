      ...
      <div className="app__footer ">
        ...
        <div className="footer-one">
          <span>
            <h1>HackyTime</h1>
            <p>
              HackyTime Tech Hackathon is a technology innovation program
        ...
        <ul>
          ...
          <li>
            <img src={Phone} alt="phone" /> +234 8054038934
          </li>
          <li>
            <img src={Location} /> Allen Avenue <br />
            Ikeja 100015 <br />
            Lagos State
          </li>
        </ul>
      </div>
      <p className="copy">All rights reserved. © HackyTime Ltd.</p>
    </div>
  );
};
